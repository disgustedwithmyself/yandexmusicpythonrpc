...
class MRPC:
    ...
    def idling():
        dRPC.update(
            ...
            large_image="https://github.com/liztochekcode/yandexmusicpythonrpc/raw/main/fallback-black_2.gif",
            small_image="https://github.com/liztochekcode/yandexmusicpythonrpc/blob/main/logo.png?raw=true",
